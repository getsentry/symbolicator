...
use symbolic::common::{DebugId, ParseDebugIdError};
...
/// Apple PropertyList structure for BCSymbolMap OriginaUUID mapping.
///
...
/// UUID of the matching [`BcSymbolMap`](symbolic::debuginfo::macho::BcSymbolMap).
#[derive(Clone, Debug)]
pub struct PList {
    id: DebugId,
